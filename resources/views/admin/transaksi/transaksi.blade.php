    ...
    <div class="w-full">
        <div class="flex justify-between flex-col md:flex-row items-center">
            ...
            <div class="flex items-center gap-4">
                <form method="GET" action="{{ route('data-transaksi.index') }}" class="flex items-center mt-4">
                ...
                <div class="relative w-auto">
                    ...
                    <input type="text" id="simple-search" onkeyup="searchTable()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition duration-150 ease-in-out" placeholder="Search Transaksi..." required />
                </div>
            </div>
        </div>

        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2">
            <table id="transaksi-tabel" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="background: gray">
