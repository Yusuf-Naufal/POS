<x-admin-layout>
    <div class="w-full p-6">
        ...
        <form id="outlet-form" action="{{ route('outlets.products.store', $outlet->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Card Container -->
            ...
            <div class="w-full flex justify-end mt-4">
                <div>
                    <a href="{{ route('outlets.products', $outlet->id) }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                        Batal
                    </a>
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <form action="{{ route('produks-unit.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="unit-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah</button>
