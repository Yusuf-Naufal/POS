<x-admin-layout>
    <div class="w-full justify-start">
        ...
        <div class="mt-2 mb-1 flex flex-col md:flex-row justify-between items-center">
            <a href="{{ route('admin.karyawan.create') }}" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                Tambah Karyawan
            </a>
            ...
            <table id="pemilik-table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="background: gray">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                             {{ $user->outlet->nama_outlet ?? "Tidak Terdaftar"}}
                        </td>
                        <td class="px-6 py-4">
                            {{ $user->status }}
                        </td>
