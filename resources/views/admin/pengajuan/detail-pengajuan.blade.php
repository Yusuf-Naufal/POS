        ...
        @csrf
            ...
            <div class="flex flex-col md:flex-row gap-4 mt-5">
                ...
                <div class="w-full lg:w-1/2 bg-gray-50 p-4 rounded-lg shadow-md">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <a href="{{ asset('storage/assets/' . $pengajuan->pemilik->foto) }}" target="_blank" class="block">
                            <img src="{{ asset('storage/assets/' . $pengajuan->pemilik->foto) }}" alt="Foto Pemilik" class="w-full max-w-xs h-auto object-cover rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform duration-200 mx-auto">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-4 mt-5">
                ...
                <div class="w-full lg:w-1/2 bg-gray-50 p-4 rounded-lg shadow-md">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <a href="{{ asset('storage/assets/' . $pengajuan->foto) }}" target="_blank" class="block">
                            <img src="{{ asset('storage/assets/' . $pengajuan->foto) }}" alt="Foto Outlet" class="w-full max-w-xs h-auto object-cover rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform duration-200 mx-auto">
                        </a>
                    </div>
                </div>
            </div>
