<x-master-layout>
    <div class="w-full p-2">
        ...
        <form id="outlet-form" action="{{ route('master.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Card Container -->
            <div class="bg-white h-auto w-full shadow-md rounded-lg p-6">
                <div class="flex flex-wrap gap-4">
                    <div class="flex w-full flex-col items-center lg:flex-row gap-4">
                        <div>
                            ...
                            <div class="flex items-center justify-center w-64 h-64">
                                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                    ...
                                    <img class="w-full h-full rounded-md" id="image-update" src="{{ asset('public/assets/'. $produk->foto) }}" alt="">
                                </label>
                            </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex flex-col lg:flex-row gap-4">
                                <div class="w-full md:w-1/3 md:mb-4">
            ...
            <div class="bg-white h-auto w-full shadow-md rounded-lg p-6 flex mt-4 flex-col lg:flex-row">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <label class="flex items-center me-5 cursor-pointer my-4">
                        <!-- Set the hidden input value dynamically based on the product's status -->
                        <input type="hidden" id="status" name="status" value="{{ $produk->status }}">
            ...
            <div class="w-full flex justify-end mt-4">
                <div>
                    <a href="{{ route('master.produk.index') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                        Batal
                    </a>
