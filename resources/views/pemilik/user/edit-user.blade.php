<x-master-layout>
    <div class="w-full p-2">
        ...
        <div class="bg-white h-auto w-full shadow-md rounded-lg p-6">
            <form id="users-form" action="{{ route('master.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <input type="hidden" id="id_outlet" name="id_outlet" value="{{ $userOutletId }}" />
