    ...
    <div class="w-full px-4 py-6 bg-gray-50">
        ...
        <div class="flex flex-col md:flex-row gap-8 bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="w-full md:w-1/3 flex justify-center items-center">
                <img src="{{ asset('storage/assets/' . $Outlet->foto) }}" alt="Outlet Image" class="w-full h-64 object-contain rounded-lg shadow-md">
            </div>
            ...
            <div class="w-full md:w-2/3 space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ $Outlet->instagram ? 'https://www.instagram.com/'.$Outlet->instagram : '#' }}" class="flex items-center px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#bc1888] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-[#bc1888]/50 rounded-lg {{ $Outlet->instagram ? '' : 'cursor-not-allowed' }}" {{ $Outlet->instagram ? '' : 'disabled' }}>
                        <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                            <path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9 114.9-51.3 114.9-114.9S287.6 141 224.1 141zm0 189.6c-41.1 0-74.7-33.6-74.7-74.7s33.6-74.7 74.7-74.7 74.7 33.6 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12.1 27-27 27-14.9 0-27-12.1-27-27s12.1-27 27-27 27 12.1 27 27zm76.1 27.2c-1.7-35.7-9.9-67.2-36.2-93.5-26.3-26.3-57.8-34.5-93.5-36.2-37-2.1-147.8-2.1-184.8 0-35.7 1.7-67.2 9.9-93.5 36.2-26.3 26.3-34.5 57.8-36.2 93.5-2.1 37-2.1 147.8 0 184.8 1.7 35.7 9.9 67.2 36.2 93.5 26.3 26.3 57.8 34.5 93.5 36.2 37 2.1 147.8 2.1 184.8 0 35.7-1.7 67.2-9.9 93.5-36.2 26.3-26.3 34.5-57.8 36.2-93.5 2.1-37 2.1-147.8 0-184.8z"/>
                        </svg>
                        {{ $Outlet->instagram ? '@'.$Outlet->instagram : 'Instagram' }}
                    </a>

                    <a href="{{ $Outlet->facebook ? 'https://www.facebook.com/'.$Outlet->facebook : '#' }}" class="flex items-center px-5 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-500 rounded-lg {{ $Outlet->facebook ? '' : 'cursor-not-allowed' }}" {{ $Outlet->facebook ? '' : 'disabled' }}>
                    ...
                    <a href="{{ $Outlet->tiktok ? 'https://www.tiktok.com/@'.$Outlet->tiktok.'?lang=id-ID' : '#' }}" class="flex items-center px-5 py-2.5 text-sm font-medium text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-500 rounded-lg {{ $Outlet->tiktok ? '' : 'cursor-not-allowed' }}" {{ $Outlet->tiktok ? '' : 'disabled' }}>
