...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-auto h-auto bg-white rounded-lg shadow-md p-3">
        <div class="max-w-[900px] min-w-80 p-4">
            <!-- Registration Form -->
        ...
        <div id="completeProfileForm" style="display: none;">
            <h2 class="text-2xl font-bold text-center mb-6">Lengkapi Data Diri</h2>
                ...
                <div class="flex w-full gap-4 px-10">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-4 w-full">
                            <label class="block text-sm font-medium text-gray-700" for="nama_outlet">Nama Langkap</label>
                        ...
                        <div class="flex gap-4">
                            <div class="w-full md:w-1/3 mb-4">
                                <label class="block text-sm font-medium text-gray-700" for="instagram">Jenis Kelamin</label>
                                <select class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="jenis_kelamin" id="">
                            ...
                            <div class="w-full md:w-1/3 mb-4">
                                ...
                                <input type="date" id="tanggal_lahir" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="tanggal_lahir">
                            </div>
                        </div>
                        <div class="mb-4 w-full">
